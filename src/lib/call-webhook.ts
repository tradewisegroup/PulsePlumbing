/**
 * Call-completion webhook (AVANSER / Delacon / generic).
 * Switching provider is a payload-shape difference handled here —
 * not a deploy of new pages.
 *
 * Header: CALL_WEBHOOK_SECRET: <shared secret>
 */

import type { Attribution } from './attribution.ts';
import { persistLeadFromModel } from './leads-db.ts';
import { buildLead, leadRef, normalisePhoneE164 } from './lead.ts';
import { workerVar } from './worker-env.ts';
