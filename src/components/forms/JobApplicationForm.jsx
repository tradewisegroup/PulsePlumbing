...
import { pushApplicationSubmitted } from '../../lib/datalayer';
      ...
      {status === 'error' && (
        ...
        >
          ...
          <span>
            ...
            <a href="tel:0452188420" data-track="call" data-call-number="emergency" data-call-location="footer" className="font-bold underline">Call 0452 188 420</a>.
          </span>
        </div>
      )}
